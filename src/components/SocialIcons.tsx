/**
 * lucide-react dropped brand marks, so the four we need live here as plain
 * filled paths on a 24×24 grid. They take `className` like any lucide icon.
 */
...
export function Twitter({ className }: IconProps) {
  return (
    <svg {...base(className)}>
      <path d="M18.9 1.15h3.68l-8.04 9.19L24 22.85h-7.4l-5.8-7.58-6.64 7.58H.47l8.6-9.83L0 1.15h7.59l5.25 6.93ZM17.6 20.64h2.04L6.49 3.24H4.3Z" />
    </svg>
  );
}
...
export function Youtube({ className }: IconProps) {
  return (
    <svg {...base(className)}>
      <path d="M23.5 6.19a3.02 3.02 0 0 0-2.12-2.14C19.5 3.54 12 3.54 12 3.54s-7.5 0-9.38.51A3.02 3.02 0 0 0 .5 6.19C0 8.07 0 12 0 12s0 3.93.5 5.81a3.02 3.02 0 0 0 2.12 2.14c1.87.51 9.38.51 9.38.51s7.5 0 9.38-.51a3.02 3.02 0 0 0 2.12-2.14C24 15.93 24 12 24 12s0-3.93-.5-5.81ZM9.55 15.57V8.43L15.82 12l-6.27 3.57Z" />
    </svg>
  );
}
