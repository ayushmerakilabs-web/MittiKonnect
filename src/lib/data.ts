...
export const homes: Home[] = [
  ...
  },
  {
    ...
    district: "Palghar",
    state: "Maharashtra",
    host: "A photographer who found love in farming",
    hostAvatar: img("photo-1507003211169-0a1dd7228f2d", 200),
    price: null, // the host quotes per group and per stay
    guests: 28,
    bedrooms: 6,
    beds: 22,
    baths: 6,
    tags: ["Organic", "Pet friendly", "Food included"],
    images: [
      "/arwa-farms-1.png",
      "/arwa-farms-2.jpg",
      "/arwa-farms-3.jpg",
    ...
    logo: "/arwa-farms-logo.jpg",
    story: [
      "“Into nature I go, to lose my mind and find my soul.” A photographer who found love in farming built this place at Dahanu as a tribute to the land it sits on — unpolluted air, a lush green canopy and a clear sky. Twenty years on, the farm has been allowed to grow into something closer to a jungle, kept deliberately as a sanctuary for the three B’s: bees, butterflies and birds.",
      "The house is red brick, unplastered so the walls can breathe, with arched porches, a swing under the arches, a machan and a terrace up in the canopy. Water is recycled, utensils are washed with farm ash, and the soap and toothpaste are chemical-free. There is no AC, no pool and no TV — that is the point. Food comes out in earthenware, cooked by locals from what the farm and the village provide.",
    ],
    checkIn: "flexible",
    checkOut: "no fixed time",
    doHere: [
      "Mud bath in the soil tub (₹300 per head)",
      "Yoga on the terrace and in the garden",
      "Kids’ activities — mud play, hay piles, goat feeding, paddy planting",
      "Cook over an open fire on the farm",
      "Meet the ducks, cows, goats and hens",
      "Fruit walk — coconut, chikoo, jackfruit, papaya, mango, pineapple, banana, cashew",
      "Play indoor games outdoors under the mango trees",
      "Work from the farm on the terrace or the machan",
    ...
    mealPlan: [
      {
        ...
        detail: "A village breakfast, served in earthenware.",
      },
      {
        meal: "Lunch",
        time: "1:30 pm – 2:30 pm",
        detail:
          "One veg and one non-veg curry (two veg for vegetarians), a dal, bhakri or chapati, rice and pickles.",
      },
      {
        meal: "Dinner",
    ...
    included: [
      ...
      "Google pin, map and video directions on booking",
    ],
    facilities: [
      "The Villa — 4 rooms, 16 beds and 4 baths, sleeps 18",
      "The Cottages — 2 rooms, 4 double and 2 single beds, 2 baths, sleeps 10",
      "Terrace and machan chill-out area in the canopy",
      "Gazebo and siesta spot under the mango trees",
      "Arched sit-out area with a swing",
      "Mud bath tub",
      "Designated parking for cars and bikes",
    ],
    nearby: [
      { name: "Pharmacy", km: 2 },
      { name: "Sakhare Dam", km: 9 },
      { name: "Hospital", km: 9 },
      { name: "Dahanu Beach", km: 10 },
      { name: "Raitali Dam", km: 10 },
      { name: "Bordi Beach", km: 26 },
    ],
    whyUs: [
      "A working organic farm for two decades, not a resort",
      "Unplastered brick house that breathes",
      "Water recycled, utensils washed with farm ash",
      "Plastic-free zone",
      "A sanctuary for bees, butterflies and birds",
      "Flexible check-in and no fixed checkout",
    ],
    notes: [
      "Check-in is flexible and there is no checkout time. If someone is arriving the next day the host will tell you in advance; you can empty the room and stay on the farm as long as you like.",
      "Carry only a towel and a toothbrush. Please don’t bring chemical products — the farm’s soap and toothpaste are provided.",
      "No outside food. No music after 10 pm — it’s the law.",
      "Meals are served at fixed times so the kitchen staff, who start at 7:30 am and eat only after every guest, can rest. If you miss dinner it is left on the kitchen table; no food warming after dinner time.",
      "The terrace, machan, shamiana and porch are self-service zones — help yourself from the kitchen.",
      "No AC, swimming pool or TV. This is basic, eco-friendly living on an organic farm.",
      "Expect ants, a lizard on the wall, the odd frog, beetle or bat — all harmless, and here long before the guests.",
      "The house has antiques; let the host know and they will move them out of a child’s reach.",
      "Carry your plastics back with you, turn off the lights, fans and geyser, and leave recyclables in the bin in your room.",
      "Cancellation: full refund up to 10 days before, 50% up to 5 days before. If the room is re-booked last minute, the full amount is refunded.",
      "By train: rickshaws wait outside Dahanu Road station; ask the host for a driver’s number.",
    ],
    packages: [
      {
        name: "The Villa",
        ...
        price: null,
        blurb:
          "The main brick house. Four rooms, sixteen beds, four baths and the terrace, for up to 18 people.",
        includes: [
          "4 rooms and 4 baths, sleeps 18",
          "All meals, served in earthenware",
          "Terrace, machan and porch",
          "Farm walk and the animals",
        ],
        popular: true,
      },
      {
        ...
        price: null,
        blurb:
          "Two brick cottages with their own porches, set apart under the trees. Four double beds and two singles for up to 10.",
        includes: [
          "2 rooms and 2 baths, sleeps 10",
          "All meals, served in earthenware",
          "Private porch on each cottage",
          "Farm walk and the animals",
        ],
      },
      {
        ...
        price: null,
        blurb:
          "Villa and cottages together for up to 28. Work under the mango trees, meet on the machan, mud bath at the end of it.",
        includes: [
          "Whole farm, 6 rooms and 6 baths",
          "All meals for the group",
          "Terrace and machan for sessions",
          "Mud bath, yoga and games arranged on request",
        ],
      },
    ],
  },
